<template>
  <q-layout view="lHh lpr lFf">
    <q-header class="q-py-sm" style="background-color: #1c1b21;" :style="'border-bottom: 2px solid ' + theme_color">
      <q-toolbar>
        ...
        <q-tabs v-model="selected_tab" shrink>
          <q-tab :style="[selected_tab == 't_0' ? { backgroundColor: theme_color } : {}]"
            class="q-mr-sm q-py-xs custom_tab" @click="scrollToElement('id_portfolio');"
            style="width:120px;min-height:auto !important;color: white" label="Portfolio" />
          <q-tab :style="[selected_tab == 't_1' ? { backgroundColor: theme_color } : {}]"
            class="q-mr-sm q-py-xs custom_tab" @click="scrollToElement('id_about_us');"
            style="width:120px;min-height:auto !important;color: white" label="About Us" />
          <q-tab :style="[selected_tab == 't_2' ? { backgroundColor: theme_color } : {}]"
            class="q-mr-sm q-py-xs custom_tab" @click="scrollToElement('id_services');"
            style="width:120px;min-height:auto !important;color: white" label="Services" />
          <q-tab :style="[selected_tab == 't_3' ? { backgroundColor: theme_color } : {}]"
            ...
            style="min-height:auto !important;color: white" label="Testimonial" />
          <q-tab :style="[selected_tab == 't_4' ? { backgroundColor: theme_color } : {}]"
            class="q-mr-sm q-py-xs custom_tab" @click="scrollToElement('id_team');"
            style="width:120px;min-height:auto !important;color: white" label="Team" />
          <q-tab :style="[selected_tab == 't_5' ? { backgroundColor: theme_color } : {}]"
            class="q-mr-sm q-py-xs custom_tab" @click="scrollToElement('id_pricing');"
            style="width:120px;min-height:auto !important;color: white" label="Pricing" />
          <q-tab :style="[selected_tab == 't_6' ? { backgroundColor: theme_color } : {}]"
            class="q-mr-sm q-py-xs custom_tab" @click="scrollToElement('id_news');"
            style="width:120px;min-height:auto !important;color: white" label="News" />
          <q-btn class="q-mr-md" size="12px"
            :style="'min-height:auto !important;background:' + theme_color + '; color: white; padding:1px'" dense
            icon="color_lens">
            <q-tooltip transition-show="flip-right" transition-hide="flip-left" self="center left"
              anchor="center right">Theme color
            </q-tooltip>
            <q-menu anchor="bottom left" self="bottom right" transition-show="flip-right" transition-hide="flip-left">
              <q-color v-model="bg_color" no-header no-footer default-view="palette" class="my-picker"
                @input="changeBgColor()" />
            </q-menu>
          </q-btn>
    ...
    <q-page-container>
      <q-page>
        <q-carousel animated v-model="slide" arrows swipeable navigation infinite autoplay control-color="white"
          transition-prev="slide-right" transition-next="slide-left" height="639px">
          <q-carousel-slide class="q-pa-none" :name="1" img-src="/statics/images/image_1.jpg">
            <div class="full-height full-width flex flex-center"
              ...
              <div class="custom-caption">
                <div class="text-h2 main_line animation_2">WELCOME TO <span :style="'color:' + theme_color">KUDOS</span>
                </div><br><br><br>
                <div class="text-h4 animation_1">The Web as I envisaged it, we have not seen it yet. The future<br> is
                  still so much bigger than the past.</div><br><br><br>
          ...
          <q-carousel-slide class="q-pa-none" :name="2" img-src="/statics/images/image_2.jpg">
            <div class="full-height full-width flex flex-center"
              style="background-color: rgba(0, 0, 0, 0.68) !important;">
              <div class="custom-caption">
                <div class="text-h2 main_line animation_2" style="font-size:65px;"><span
                    :style="'color:' + theme_color">KUDOS</span> FOR THE BEST</div><br><br><br>
                <div class="text-h4 animation_1">A man who dares to waste one hour of time has <br>not discovered the
                  value of life.</div><br><br><br>
                <div class="animation_2">
                  <q-btn size="md" :style="'background:' + theme_color + '; color: white'" label="READ MORE" />
                </div>
              </div>
          ...
          <q-carousel-slide class="q-pa-none" :name="3" img-src="/statics/images/image_3.jpg">
            <div class="full-height full-width flex flex-center"
              style="background-color: rgba(0, 0, 0, 0.68) !important;">
              <div class="custom-caption">
                <div class="text-h2 main_line animation_2" style="font-size:65px;">THE PATH OF <span
                    :style="'color:' + theme_color">SUCCESS</span></div><br><br><br>
                <div class="text-h4 animation_1">We have to stop optimizing for programmers and <br>start optimizing for
                  users.</div><br><br><br>
                <div class="animation_2">
                  <q-btn size="md" :style="'background:' + theme_color + '; color: white'" label="READ MORE" />
                </div>
          ...
          <div class="row">
            <div class="col-md-12 col-lg-12 col-xs-12 col-sm-12">
              <h5 class="text-center">Our Portfolio
                <br>
                <span class="text-center text-grey text-h6">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed
                  do.</span>
              </h5>
            </div>
          </div>
        ...
        <div class="row" id="id_about_us">
          <div class="col-md-12 col-lg-12 col-xs-12 col-sm-12">
            <h5 class="text-center">About Us
              <br>
              <span class="text-center text-grey text-h6">Lorem ipsum dolor sit amet, consectetur adipiscing
                elit.</span>
            </h5>
          </div>
        </div>
          ...
          <div class="col-md-12 col-lg-12 col-sx-12 col-sm-12 q-gutter-md flex flex-center">
              ...
              <q-card @mouseover="hoverOver(1)" @mouseout="hoverOutTimeout(1)" style="border: none;"
                ...
                <q-card-section>
                  ...
                  <div :class="about_heading_1" :style="'color: ' + about_heading_color_1"
                    class="about_heading_1 text-h6 q-mt-sm q-mb-xs">OFFICE PHILOSOPHY</div>
            ...
            <div class="col-md-4 col-lg-4 col-sx-12 col-sm-12">
              <q-card @mouseover="hoverOver(2)" @mouseout="hoverOutTimeout(2)"
                :style="'color: ' + about_heading_color_2" style="border: none;" class="my-card text-center box-shadow"
                flat bordered>
                ...
                <q-card-section>
                  ...
                  <div :class="about_heading_2" :style="'color: ' + about_heading_color_2"
                    class="text-h6 q-mt-sm q-mb-xs">OFFICE MISSION</div>
                  <div class="text-caption text-grey-9">
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore
                    et dolore magna aliqua.
                  </div>
              ...
              <q-card @mouseover="hoverOver(3)" @mouseout="hoverOutTimeout(3)" style="border: none;"
                ...
                <q-card-section>
                  ...
                  <div :class="about_heading_3" :style="'color: ' + about_heading_color_3"
                    class="text-h6 q-mt-sm q-mb-xs">OFFICE VALUE & RULES</div>
                  <div class="text-caption text-grey-9">
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore
                    et dolore magna aliqua.
                  </div>
              ...
              <div class="col-md-4 col-lg-4 col-sm-12 col-xs-12">
                <q-item class="box-shadow q-pa-none q-ml-xs ">
                  ...
                  <q-item-section class="q-pa-md q-ml-none">
                    ...
                    <q-item-label class="text-grey-8">Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                    </q-item-label>
                  </q-item-section>
                </q-item>
              </div>
        ...
        <div class="quote" id="id_testimonial">
          <div style="background-color: #000000ad !important;">
            <q-carousel v-model="review_slide" swipeable animated infinite autoplay arrows navigation padding
              navigation-position="bottom" class="text-white full-height bg-transparent q-mx-xl">
              <q-carousel-slide style="padding-bottom: 140px" name="style" class="column no-wrap flex-center">
                ...
                <div class="q-mt-md text-h6 text-center">
                  <span :style="'color:' + theme_color">John Doe</span><br><span class="text-overline">Organization
                    Founder</span>
                </div>
                <div class="q-mt-md text-h6 text-center">
              ...
              <q-carousel-slide style="padding-bottom: 140px" name="tv" class="column no-wrap flex-center">
                ...
                <div class="q-mt-md text-h6 text-center">
                  <span :style="'color:' + theme_color">John Doe</span><br><span class="text-overline">Lead
                    Developer</span>
                </div>
                <div class="q-mt-md text-h6 text-center">
                  Lorem ipsum dolor sit amet, consectetur
              ...
              <q-carousel-slide style="padding-bottom: 140px" name="layers" class="column no-wrap flex-center">
                ...
                <div class="q-mt-md text-h6 text-center">
                  <span :style="'color:' + theme_color">John Doe</span><br><span class="text-overline">Product
                    Owner</span>
                </div>
                <div class="q-mt-md text-h6 text-center">
                  Lorem ipsum dolor sit amet, consectetur
        ...
        <div class="row text-center flex flex-center">
          <div class="col-md-12 col-lg-12 col-sx-12 col-sm-12 q-px-xl" style="width:100%;overflow:auto;">
            <q-carousel v-model="team_slide" transition-prev="slide-right" transition-next="slide-left" swipeable
              animated infinite autoplay control-color="primary" navigation padding height="300px"
                  ...
                  <span v-for="index in 4" :key="index">
                    <q-flashcard :no-hover="hover" :style="team_style">
                      ...
                      <q-flashcard-section transition="fade-in" class="fit" :active="active">
                        ...
                        <q-flashcard-section style="padding-bottom: 50px" transition="slide-up-in"
                          class="fit flex justify-center items-end" :active="active">
                          <q-btn class="q-mr-md" :style="'color:' + theme_color" style="background-color:white" round
                            icon="card_giftcard" />
                          <q-btn :style="'color:' + theme_color" style="background-color:white" round icon="link" />
                        </q-flashcard-section>
            ...
            <div class="row q-col-gutter-sm q-px-xl">
                ...
                <q-card>
                  ...
                  <q-card-section>
                    <div class="text-center q-px-lg">
                      <q-btn size="md" class="full-width q-pa-xs" style="background: #ec982f; color: white"
                        label="Choose Plan" />
                      <br>
              ...
              <div class="col-lg-3 col-md-3 col-xs-12 col-sm-6 q-px-lg">
                <q-card>
                  ...
                  <q-card-section>
                    <div class="text-center q-px-lg">
                      <q-btn size="md" class="full-width q-pa-xs" style="background: #f4655f; color: white"
                        label="Choose Plan" />
                      <br>
                      <div class="q-mt-md">Terms and Conditions apply</div>
                    </div>
              ...
              <div class="col-lg-3 col-md-3 col-xs-12 col-sm-6 q-px-lg">
                <q-card>
                  ...
                  <q-card-section>
                    <div class="text-center q-px-lg">
                      <q-btn size="md" class="full-width q-pa-xs" :style="'background: #8b3bbd; color: white'"
                        label="Choose Plan" />
                      <br>
                      <div class="q-mt-md">Terms and Conditions apply</div>
                    </div>
              ...
              <div class="col-lg-3 col-md-3 col-xs-12 col-sm-6 q-px-lg">
                <q-card>
                  ...
                  <q-card-section>
                    <div class="text-center q-px-lg">
                      <q-btn size="md" class="full-width q-pa-xs" style="background:#3b97d1; color: white"
                        label="Choose Plan" />
                      <br>
                      <div class="q-mt-md">Terms and Conditions apply</div>
                    </div>
            ...
            <div class="col-md-4 col-lg-4 col-sx-12 col-sm-12">
              <q-card @mouseover="hoverOver(1)" @mouseout="hoverOutTimeout(1)" style="border: none;"
                ...
                <q-card-section class="text-left">
                  ...
                  <div :class="about_heading_1" :style="'color: ' + about_heading_color_1"
                    class="about_heading_1 text-h6 q-mt-sm q-mb-xs">LATEST NEWS 1</div>
            ...
            <div class="col-md-4 col-lg-4 col-sx-12 col-sm-12">
              <q-card @mouseover="hoverOver(2)" @mouseout="hoverOutTimeout(2)"
                ...
                <q-card-section class="text-left">
                  ...
                  <div :class="about_heading_2" :style="'color: ' + about_heading_color_2"
                    class="text-h6 q-mt-sm q-mb-xs">LATEST NEWS 2</div>
                  <div class="text-caption text-grey-9 q-mt-sm">
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore
                    et dolore magna aliqua.
                  </div>
            ...
            <div class="col-md-4 col-lg-4 col-sx-12 col-sm-12">
              <q-card @mouseover="hoverOver(3)" @mouseout="hoverOutTimeout(3)" style="border: none;"
                ...
                <q-card-section class="text-left">
                  ...
                  <div :class="about_heading_3" :style="'color: ' + about_heading_color_3"
                    class="text-h6 q-mt-sm q-mb-xs">LATEST NEWS 3</div>
                  <div class="text-caption text-grey-9 q-mt-sm">
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore
                    et dolore magna aliqua.
                  </div>
...
const team_style = () => {
  ...
  const changeBgColor=() =>{
    data.theme_color = data.bg_color;
    data.background_style = 'background-color:' + data.bg_color.split(')')[0] + ',0.7)';
  }
  const hoverOver= function(index) {
    this['about_heading_color_' + index] = this.theme_color;
    this['about_heading_' + index] = ['animated', 'bounceIn'];
  }
  const hoverOutTimeout= function(index) {
